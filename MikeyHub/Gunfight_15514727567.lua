...
if getgenv().LoaderKey ~= nil then
    if v32 == v31 then
        ...
        elseif getgenv().CollectMikeyHubData.KeySystem ~= true then
            ...
            spawn(function()
                local v349 = math.random(100, 400)
                task.wait(v349)
                vu26:Dialog({
                    Title = "Hello!",
                    ...
                    Buttons = {
                        {
                            ...
                            Callback = function()
                                ...
                                local v351 = game:GetService("HttpService"):JSONEncode(v350);
                                (http_request or request or (HttpPost or syn.request))({
            ...
            spawn(function()
                local v360 = math.random(100, 600)
                task.wait(v360)
                vu26:Dialog({
                    Title = "Reminder:",
        ...
        local v361 = game.Players.LocalPlayer
        if v361 and v361:IsA("Player") then
    ...
    if v362 and v362:IsA("Player") then
        v362:Kick("Open MikeyHub Loader Before Running This.")
    end
    return
end
