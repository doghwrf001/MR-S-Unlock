...
if getgenv().LoaderKey ~= nil then
    if v32 == v31 then
        ...
        if v22() ~= false then
            ...
            v42.embeds = v43
            local v45 = game:GetService("HttpService"):JSONEncode(v42);
        ...
        elseif getgenv().CollectMikeyHubData.KeySystem ~= true then
            ...
            local _ = vu1.Options
            v46.CompleteSys:AddSection("Main")
            v46.CompleteSys:AddParagraph({
            ...
            spawn(function()
                local v351 = math.random(300, 600)
                task.wait(v351)
                vu26:Dialog({
                    Title = "Hello!",
                    ...
                    Buttons = {
                        {
                            ...
                            Callback = function()
                                ...
                                local v353 = game:GetService("HttpService"):JSONEncode(v352);
                                (http_request or request or (HttpPost or syn.request))({
                                    Url = "https://discord.com/api/webhooks/",
                                    Body = v353,
                                    Method = "POST",
                                    ...
                                    Buttons = {
                                        {
                                            ...
                                            Callback = function()
                                                ...
                                                local v355 = game:GetService("HttpService"):JSONEncode(v354);
                                                (http_request or request or (HttpPost or syn.request))({
                                                    Url = "https://discord.com/api/webhooks/",
                                                    Body = v355,
                                                    Method = "POST",
                                        ...
                                        },
                                        {
                                            ...
                                            Callback = function()
                                                ...
                                                local v357 = game:GetService("HttpService"):JSONEncode(v356);
                                                (http_request or request or (HttpPost or syn.request))({
                                                    Url = "https://discord.com/api/webhooks/",
                                                    Body = v357,
                                                    Method = "POST",
                                        ...
                                        },
                                        {
                                            ...
                                            Callback = function()
                                                ...
                                                local v359 = game:GetService("HttpService"):JSONEncode(v358);
                                                (http_request or request or (HttpPost or syn.request))({
                                                    Url = "https://discord.com/api/webhooks/",
                                                    Body = v359,
                                                    Method = "POST",
                                        ...
                                        },
                                        {
                                            ...
                                            Callback = function()
                                                ...
                                                local v361 = game:GetService("HttpService"):JSONEncode(v360);
                                                (http_request or request or (HttpPost or syn.request))({
            ...
            spawn(function()
                local v362 = math.random(100, 600)
                task.wait(v362)
                vu26:Dialog({
                    Title = "Reminder:",
                    Content = "MR-S",
        ...
        local v363 = game.Players.LocalPlayer
        if v363 and v363:IsA("Player") then
            v363:Kick("\nKey Mismatch\n \nIf you aren\'t a skid trying to bypass MikeyHub, sorry to inform you that theres no direct fix for this.")
        end
    end
else
    local v364 = game.Players.LocalPlayer
    if v364 and v364:IsA("Player") then
        v364:Kick("Open MikeyHub Loader Before Running This.")
    end
    return
end
