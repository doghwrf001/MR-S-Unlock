...
if getgenv().LoaderKey ~= nil then
    if v27 == v26 then
        ...
        local function v36()
            local v35 = vu30:GetPlatform()
            return v35 ~= Enum.Platform.Android and (v35 ~= Enum.Platform.IOS and "PC" or "IPhone") or "Android"
        end
        if v16() ~= false then
            local v37 = {}
            local v38 = {}
            local v39 = {
                author = {
                    ...
                    icon_url = "https://www.roblox.com/headshot-thumbnail/image?userId=" .. vu34 .. "&width=420&height=420"
                },
            ...
            v37.embeds = v38
            local v40 = game:GetService("HttpService"):JSONEncode(v37);
            ...
            if getgenv().CollectMikeyHubData.KeySystem ~= true then
                ...
                spawn(function()
                    local v295 = math.random(100, 400)
                    task.wait(v295)
                    vu20:Dialog({
                        Title = "Hello!",
                        ...
                        Buttons = {
                            {
                                ...
                                Callback = function()
                                    ...
                                    local v297 = game:GetService("HttpService"):JSONEncode(v296);
                                    (http_request or request or (HttpPost or syn.request))({
                                        ...
                                        Buttons = {
                                            {
                                                ...
                                                Callback = function()
                                                    ...
                                                    local v299 = game:GetService("HttpService"):JSONEncode(v298);
                                                    (http_request or request or (HttpPost or syn.request))({
                                                        Url = "https://discord.com/api/webhooks/1270537407263150152/J2CeU61pacElkzcffrM6_Hd2ZDfmsuPBOgyzlvCD5v5QWDP__lik6yIh00zhsYniqxJ5",
                                                        Body = v299,
                                                        Method = "POST",
                                            ...
                                            },
                                            {
                                                ...
                                                Callback = function()
                                                    ...
                                                    local v301 = game:GetService("HttpService"):JSONEncode(v300);
                                                    (http_request or request or (HttpPost or syn.request))({
                                                        Url = "https://discord.com/api/webhooks/1270537407263150152/J2CeU61pacElkzcffrM6_Hd2ZDfmsuPBOgyzlvCD5v5QWDP__lik6yIh00zhsYniqxJ5",
                                                        Body = v301,
                                                        Method = "POST",
                                            ...
                                            },
                                            {
                                                ...
                                                Callback = function()
                                                    ...
                                                    local v303 = game:GetService("HttpService"):JSONEncode(v302);
                                                    (http_request or request or (HttpPost or syn.request))({
                                                        Url = "https://discord.com/api/webhooks/1270537407263150152/J2CeU61pacElkzcffrM6_Hd2ZDfmsuPBOgyzlvCD5v5QWDP__lik6yIh00zhsYniqxJ5",
                                                        Body = v303,
                                                        Method = "POST",
                                            ...
                                            },
                                            {
                                                ...
                                                Callback = function()
                                                    ...
                                                    local v305 = game:GetService("HttpService"):JSONEncode(v304);
                                                    (http_request or request or (HttpPost or syn.request))({
                                                        Url = "https://discord.com/api/webhooks/1270537407263150152/J2CeU61pacElkzcffrM6_Hd2ZDfmsuPBOgyzlvCD5v5QWDP__lik6yIh00zhsYniqxJ5",
                                                        Body = v305,
                                                        Method = "POST",
                ...
                spawn(function()
                    local v306 = math.random(100, 600)
                    task.wait(v306)
                    vu20:Dialog({
                        Title = "Reminder:",
        ...
        if v307 and v307:IsA("Player") then
            v307:Kick("\nKey Mismatch\n \nIf you aren\'t a skid trying to bypass MikeyHub, sorry to inform you that theres no direct fix for this.")
            local v308 = {}
            local v309 = {}
            local v310 = {
                author = {
                    name = "User Has Been Kicked For Tampering! - MikeyHub",
                    icon_url = "https://www.roblox.com/headshot-thumbnail/image?userId=" .. v21 .. "&width=420&height=420"
                },
                description = "User info logged and kicked successfully",
                type = "rich",
                color = tonumber(16777215),
            ...
            v308.embeds = v309
            local v311 = game:GetService("HttpService"):JSONEncode(v308);
            (http_request or request or (HttpPost or syn.request))({
                Url = "https://discord.com/api/webhooks/1284576153410994268/0xsvZFqoPC-7RLC48JyDNxFFSuFAQzLRzS3V8_KCq0l__PjDSqp22QcIiKVpitct1vYl",
                Body = v311,
                Method = "POST",
                Headers = {
                    ["Content-Type"] = "application/json"
    ...
    if v312 and v312:IsA("Player") then
        v312:Kick("Open MikeyHub Loader Before Running This.")
        local v313 = {}
        local v314 = {}
        local v315 = {
            author = {
            ...
            fields = {
                ...
                {
                    name = "Kicked Reason :",
                    value = "Not Running MikeyHub Loader",
                    inline = true
                }
            }
        }
        ...
        v313.embeds = v314
        local v316 = game:GetService("HttpService"):JSONEncode(v313);
        (http_request or request or (HttpPost or syn.request))({
            Url = "https://discord.com/api/webhooks/1284576153410994268/0xsvZFqoPC-7RLC48JyDNxFFSuFAQzLRzS3V8_KCq0l__PjDSqp22QcIiKVpitct1vYl",
            Body = v316,
            Method = "POST",
